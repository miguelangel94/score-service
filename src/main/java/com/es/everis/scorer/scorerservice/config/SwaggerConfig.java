package com.es.everis.scorer.scorerservice.config;
 ...
 * 
 * http://localhost:8088/spotify/v1/swagger-ui.html http://localhost:8089/swagger-ui.html#/ <br/>
 * <br/>
 *
 ...
 * Step 2: goto http://editor.swagger.io/ : its an editor which is online and do paste JSON and
 * generate document<br/>
 *
 */
@Configuration
@EnableSwagger2
